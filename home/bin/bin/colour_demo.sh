...
function 0r8ht_src_codes() {
  ...
  printf "╭──────────────────────────────────────╮\n"
  printf "│ 0m \e[0mReset / Normal\e[0m                    │\n"
  printf "│ 1m \e[1mBold or increased intensity\e[0m       │ \n"
  printf "│ 2m \e[2mFaint (decreased intensity)\e[0m       │ \n"
  printf "│ 3m \e[3mItalic\e[0m                            │ \n"
  printf "│ 4m \e[4mUnderline\e[0m                         │ \n"
  printf "│ 5m \e[5mSlow Blink\e[0m                        │ \n"
  printf "│ 7m \e[7mReverse video\e[0m                     │ \n"
  printf "│ 8m \e[8mConceal\e[0m                           │ \n"
  printf "│ 9m \e[9mCrossed-out\e[0m                       │ \n"
  printf "│ 21m \e[21mBold off or Double underline\e[0m     │ \n"
  printf "│ 22m \e[22mNormal color or intensity\e[0m        │ \n"
  printf "│ 23m \e[23mNot italic\e[0m                       │ \n"
  printf "│ 24m \e[24mUnderline off\e[0m                    │ \n"
  printf "│ 25m \e[25mBlink off\e[0m                        │ \n"
  printf "│ 27m \e[27mPositive image\e[0m                   │ \n"
  printf "│ 28m \e[28mReveal\e[0m                           │ \n"
  printf "│ 29m \e[29mNot crossed out\e[0m                  │ \n"
  printf "╰──────────────────────────────────────╯\n"
}
